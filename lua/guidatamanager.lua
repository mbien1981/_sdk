-- source: https://github.com/simon-wh/Payday-The-Heist-BLT-Lua/blob/master/mods/base/req/gui_data.lua
--* Ported from PD2
...
function GuiDataManager:layout_workspace(ws)
	ws:set_screen(
		self._saferect_data.w,
		self._saferect_data.h,
		self._saferect_data.x,
		self._saferect_data.y,
		self._saferect_data.on_screen_width
	)
end

function GuiDataManager:layout_fullscreen_workspace(ws)
	ws:set_screen(
		self._fullrect_data.w,
		self._fullrect_data.h,
		self._fullrect_data.x,
		self._fullrect_data.y,
		self._fullrect_data.on_screen_width
	)
end

function GuiDataManager:layout_fullscreen_16_9_workspace(ws)
	ws:set_screen(
		self._fullrect_16_9_data.w,
		self._fullrect_16_9_data.h,
		self._fullrect_16_9_data.x,
		self._fullrect_16_9_data.y,
		self._fullrect_16_9_data.on_screen_width
	)
end

function GuiDataManager:layout_corner_saferect_workspace(ws)
	ws:set_screen(
		self._corner_saferect_data.w,
		self._corner_saferect_data.h,
		self._corner_saferect_data.x,
		self._corner_saferect_data.y,
		self._corner_saferect_data.on_screen_width
	)
end

function GuiDataManager:layout_1280_workspace(ws)
	ws:set_screen(
		self._fullrect_1280_data.w,
		self._fullrect_1280_data.h,
		self._fullrect_1280_data.x,
		self._fullrect_1280_data.y,
		self._fullrect_1280_data.on_screen_width
	)
end

function GuiDataManager:layout_corner_saferect_1280_workspace(ws)
	ws:set_screen(
		self._corner_saferect_1280_data.w,
		self._corner_saferect_1280_data.h,
		self._corner_saferect_1280_data.x,
		self._corner_saferect_1280_data.y,
		self._corner_saferect_1280_data.on_screen_width
	)
end
